...
QT_MOC_LITERAL(1, 9, 14), // "onTimerTimeout"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "CodeView\0onTimerTimeout\0"
};
...
void CodeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CodeView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CodeView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CodeView.data,
    qt_meta_data_CodeView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
