...
QT_MOC_LITERAL(1, 5, 11), // "onGdbOutput"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 8) // "socketNr"

    },
    "Core\0onGdbOutput\0\0socketNr"
};
...
void Core::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onGdbOutput((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject Core::staticMetaObject = { {
    &GdbComListener::staticMetaObject,
...
void *Core::qt_metacast(const char *_clname)
{
    ...
    return GdbComListener::qt_metacast(_clname);
}

int Core::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GdbComListener::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
